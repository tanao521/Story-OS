...
class NarrativeTurnError(ValueError):
    ...
    TURN_ALREADY_CONFIRMED = "NARRATIVE_TURN_ALREADY_CONFIRMED"
    ...
    CONFIRM_RECOVERY_REQUIRED = "NARRATIVE_TURN_CONFIRM_RECOVERY_REQUIRED"
    CONTEXT_STALE = "NARRATIVE_TURN_CONTEXT_STALE"
    VALIDATION_STALE = "NARRATIVE_TURN_VALIDATION_STALE"
    PREVIEW_STALE = "NARRATIVE_TURN_PREVIEW_STALE"
    BRANCH_OPERATION_CONFLICT = "NARRATIVE_TURN_BRANCH_OPERATION_CONFLICT"
    PROJECT_NOT_FOUND = "NARRATIVE_TURN_PROJECT_NOT_FOUND"
    TIMELINE_NOT_FOUND = "NARRATIVE_TURN_TIMELINE_NOT_FOUND"
    BRANCH_NOT_FOUND = "NARRATIVE_TURN_BRANCH_NOT_FOUND"
    PARENT_BRANCH_NOT_FOUND = "NARRATIVE_TURN_PARENT_BRANCH_NOT_FOUND"
    REPLACEMENT_BRANCH_NOT_FOUND = "NARRATIVE_TURN_REPLACEMENT_BRANCH_NOT_FOUND"
    BRANCH_ALREADY_EXISTS = "NARRATIVE_TURN_BRANCH_ALREADY_EXISTS"
    PARENT_BRANCH_ARCHIVED = "NARRATIVE_TURN_PARENT_BRANCH_ARCHIVED"
    INVALID_REPLACEMENT_BRANCH = "NARRATIVE_TURN_INVALID_REPLACEMENT_BRANCH"
...
class BranchOperationRecord:
    ...
    def __post_init__(self) -> None:
        ...
        _validate_datetime(self.created_at, "created_at")
        _validate_fingerprint(self.record_fingerprint, "record_fingerprint")
        if self.canonical_request_fingerprint is not None:
            _validate_fingerprint(self.canonical_request_fingerprint, "canonical_request_fingerprint")
